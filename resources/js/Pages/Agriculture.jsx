...
const Agriculture = () => {
  ...
  // SEO data with consistent agriculture keywords
  const seoData = {
    title: "Agriculture Division | Sustainable Farming Solutions in Nepal | Himalaya Organization",
    description: "Himalaya Organization's Agriculture Division provides high-yield seeds, modern irrigation systems, greenhouse solutions, organic farming training, market linkages, and agri-finance support. Driving sustainable farming and food security across Nepal since 1991.",
    url: "https://www.himalayaorganization.com/agriculture",
    ...
    <MainWrapper>
      ...
      <div className='w-full min-h-screen p-2 sm:p-4 text-white'>
        ...
        <BusinessFeatures 
          ...
          maintext={"From Seeds to Supply Chains"} 
          subtext={"Investing in modern agrotech, we support Nepal's farmers and markets across the entire agricultural value chain. From certified seed supply to irrigation systems and export facilitation, we're with you at every step."}
        />
