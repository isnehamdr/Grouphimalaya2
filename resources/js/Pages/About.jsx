...
const About = () => {
  ...
  // SEO data with consistent keywords
  const seoData = {
    title: "About Organization | Driving Success with Expert Auto Solutions Since 1991",
    description: "Himalaya Organization - Nepal's premier auto solutions provider since 1991. From specialized recondition center to multi-sector powerhouse in Pokhara. Expert automotive services with 30+ years of legacy.",
    url: "https://www.himalayaorganization.com/about",
    image: "/images/about_main.avif", // Using the hero image for social sharing
  }
