    ...
    <MainWrapper>
      ...
      <div className='w-full min-h-screen p-2 sm:p-4 text-white'>
        ...
        <BusinessFeatures 
          ...
          maintext={"Engineering Excellence Across Nepal"} 
          subtext={"From civil construction to industrial commissioning, our engineering division delivers precision, durability, and innovation for infrastructure projects nationwide. Expert consulting, fabrication, and maintenance services available."}
        />
