...
const Hospitality = () => {
  ...
  // SEO data with consistent hospitality keywords
  const seoData = {
    title: "Hospitality Division | Luxury Resorts & Hotels in Nepal | Himalaya Organization",
    description: "Experience world-class hospitality at Himalaya Organization's properties including Mountain Glory Forest Resort & Spa in Pokhara and Hotel Crowne Imperial in Kathmandu. Luxury resorts, conference facilities, destination weddings, and authentic Nepali hospitality since 1991.",
    url: "https://www.himalayaorganization.com/hospitality",
