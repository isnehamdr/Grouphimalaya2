...
const RealEstate = () => {
  ...
  // SEO data with consistent real estate keywords
  const seoData = {
    title: "Real Estate Division | Residential & Commercial Properties in Nepal | Himalaya Organization",
    description: "Himalaya Organization's Real Estate Division offers premium residential apartments, villas, commercial complexes, gated communities, affordable housing, land development, and property management services in Nepal. Building quality living spaces since 1991.",
    url: "https://www.himalayaorganization.com/real-estate",
    ...
    <MainWrapper>
      ...
      <div className='w-full min-h-screen p-2 sm:p-4 text-white'>
        ...
        <BusinessFeatures 
          ...
          maintext={"Long-Term Value, Transparent Dealings"} 
          subtext={"Strategic locations, transparent dealings, and post-sale support ensure long-term value for homeowners and investors alike. Our reputation, built over 30+ years, is your guarantee of quality and integrity."}
        />
